...
rs = pstmt.executeQuery();		// 여기에 와서야 기존 문자열이던 것들이 쿼리문으로 실행됨.
rs.next();

String name = rs.getString("name");
String title = rs.getString("title");
String contents = rs.getString("contents").trim();		//trim 여백 삭베
...
pstmt = conn.prepareStatement(str);
pstmt.setInt(1, Integer.parseInt(num));		// 클릭할 때마다 하나씩 증가 
pstmt.executeUpdate();
